...
abstract class BasePublicationForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'blogs_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('blog'), 'add_empty' => false)),
    ));
    ...
    $this->setValidators(array(
      ...
      'blogs_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('blog'))),
    ));

    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Publication', 'column' => array('id')))
    );
