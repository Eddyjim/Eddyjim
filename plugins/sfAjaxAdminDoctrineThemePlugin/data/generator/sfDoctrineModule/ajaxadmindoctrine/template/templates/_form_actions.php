...
<?php if ('_delete' == $name): ?>
  <?php echo $this->addCredentialCondition('[?php echo str_replace(\'f.submit()\', \'ajaxadmindoctrine_executeDeleteAction(this.href, f)\', $helper->linkToDelete($form->getObject(), '.$this->asPhp($params).')) ?]', $params) ?>
